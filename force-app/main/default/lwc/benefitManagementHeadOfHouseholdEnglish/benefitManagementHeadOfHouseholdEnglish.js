...
import { OMNIDEF } from './benefitManagementHeadOfHouseholdEnglish_def.js';
import tmpl from './benefitManagementHeadOfHouseholdEnglish.html';
import tmpl_nds from './benefitManagementHeadOfHouseholdEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class benefitManagementHeadOfHouseholdEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
