...
import { OMNIDEF } from './licensingAndPermittingBusinessLicenseApplicationEnglish_def.js';
import tmpl from './licensingAndPermittingBusinessLicenseApplicationEnglish.html';
import tmpl_nds from './licensingAndPermittingBusinessLicenseApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class licensingAndPermittingBusinessLicenseApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
