...
import { OMNIDEF } from './vRFConditionsEnglish_def.js';
import tmpl from './vRFConditionsEnglish.html';
import tmpl_nds from './vRFConditionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vRFConditionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
