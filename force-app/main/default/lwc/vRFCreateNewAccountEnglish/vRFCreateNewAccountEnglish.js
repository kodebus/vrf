...
import { OMNIDEF } from './vRFCreateNewAccountEnglish_def.js';
import tmpl from './vRFCreateNewAccountEnglish.html';
import tmpl_nds from './vRFCreateNewAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vRFCreateNewAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
