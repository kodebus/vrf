...
import { OMNIDEF } from './vRFCreateNewUserEnglish_def.js';
import tmpl from './vRFCreateNewUserEnglish.html';
import tmpl_nds from './vRFCreateNewUserEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vRFCreateNewUserEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
